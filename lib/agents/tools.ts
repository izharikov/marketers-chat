...
import { assetToolsConfig, componentsToolsConfig, contentToolsConfig, pagesToolsConfig, sitesToolsConfig, jobToolsConfig, environmentToolsConfig, personalizationToolsConfig } from "./config";
...
export function clientEnvironmentTools() {
    return {
...
export function clientPersonalizationTools() {
    return {
...
export function clientJobTools() {
    return {
...
export function clientPagesTools() {
    return {
...
export function clientSitesTools() {
    return {
...
export function clientContentTools() {
    return {
...
export function clientComponentsTools() {
    return {
